...
// daysAgoAt() en features/clients/roster.ts), para que racha/actividad/récords tengan sentido
// sin importar qué día se mire la demo. Reemplazar por consultas reales (Prisma) cuando se
// persista lo que el cliente completa de verdad — hoy no hay backend para eso.
