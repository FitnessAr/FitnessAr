export type Student = {
  name: string;
  // Solo presente si esta persona tiene login de demo (features/auth/demo-accounts.ts).
  loginId?: string;
...
// Fuente única de todas las personas alumnas de la demo (asignadas o no) — tanto el roster de
// cada profesor (features/profesor/roster.ts, filtrado por assignedProfessorId) como el lado
// alumno (features/alumno/active-routine.ts, resuelto por loginId) consultan este mismo pool, en
// vez de tener cada uno su propio mock desincronizado.
